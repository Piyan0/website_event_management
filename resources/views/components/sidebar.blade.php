  <div style="width: 180px; height: 100%; background-color: white; box-shadow: 2px 2px 8px #d9dfe9" class="rounded-2 fol justify-content-between py-4 alen">
    ...
    <div class="fow alen gap-2">
      <div style="width: 40px; height: 40px; background-image: url(https://avatar.iran.liara.run/public/16)" class="bg-img rounded-circle"></div>
      <div class="fol">
        <p class="f-8 g-0">Now logged in as</p>
        <p class="f-12 ">Piyan Apriyanto</p>
      </div>
    </div>
  </div>
